...
{
	$("body").append('<iframe frameborder="0" id="'+ frame +'" src="/admin/article/upload?title='+ encodeURI(title) +'&type='+ type +'&desc='+ encodeURI(desc) +'&num='+ num +'&size='+ size +'&frame='+ frame +'&input='+ input +'&area='+ area +'" allowtransparency="true" class="uploadframe" scrolling="no"></iframe>');
